...
public interface PaymentCustomNameUserRepo extends JpaRepository<PaymentEntity,String> {
    ...
    List<Tuple> findByNamePhoneEmailUser(String name_, String phone_, String email_);
