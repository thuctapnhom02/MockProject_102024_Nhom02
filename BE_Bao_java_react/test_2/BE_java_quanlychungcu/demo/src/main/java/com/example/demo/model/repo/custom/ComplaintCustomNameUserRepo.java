...
import com.example.demo.model.entity.ComplaintEntity;
...
public interface ComplaintCustomNameUserRepo extends JpaRepository<ComplaintEntity,String> {
    ...
    @Query(value = "select c.id_, u.name_ , c.status_, c.complaint_date_, c.expected_completion_date_, c.content_of_complaint_ , c.note_ ,c.id_apartment_, a.num_apartment_ ,c.id_staff_, s.name_ " +
            "from user_ u, complaints_ c ,apartment_ a " +
