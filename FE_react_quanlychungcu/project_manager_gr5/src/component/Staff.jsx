...
export default function Staff(){
    ...
    function funcSearchStaff(){
        ...
        let a = "http://127.0.0.1:9090/api/v1/resident-payments/staff/search"
        a+="?name_="+search_.name_
        a+="&status_="+search_.status_
    ...
    function funcAddStaff(){
        ...
        if(addStaff.name_&&addStaff.phone_&&addStaff.id_role_&&addStaff.password_&&addStaff.gender_&&addStaff.start_day_&&addStaff.end_day_&&addStaff.status_&&addStaff.address_){
            axios("http://127.0.0.1:9090/api/v1/resident-payments/staff/create",{
                method:"POST",
                headers:{
                    Authorization:tokenParam_,
                    "Content-Type":'application/json'
    ...
    function funcDeleteStaff(){
        ...
        axios("http://127.0.0.1:9090/api/v1/resident-payments/staff/delete/"+idStaffNow_,{
            method:"DELETE",
            headers:{
                Authorization:tokenParam_,
    ...
    axios("http://127.0.0.1:9090/api/v1/resident-payments/staff/update",{
        method:"PUT",
        headers:{
            Authorization:tokenParam_,
            "Content-Type":'application/json'
