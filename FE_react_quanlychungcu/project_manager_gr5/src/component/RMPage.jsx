    ...
    */
    ...
    function funcsearch(){
        ...
        */ 
        ...
        let a = "http://127.0.0.1:9090/api/v1/resident-payments/search"
        a+="?name="+name_+"&"
        a+="phone="+phone_+"&"
        a+="email="+email_+"&"
        if(nameApartment_!=0){
            a+="apartment_id="+nameApartment_
        }
        console.log(a)
        axios(a, {
            method: 'GET',
    ...
    function funcreloadDataUserAndPayment(){
        ...
        */
        ...
        axios("http://127.0.0.1:9090/api/v1/resident-payments/search", {
            method: 'GET',
            headers: {
                'Authorization': tokenParam_,
    ...
    function funcUpdatePayment(){
        ...
        */
        ...
        axios("http://127.0.0.1:9090/api/v1/resident-payments/update-payment",{
            method:"PUT",
            headers:{
                Authorization:tokenParam_,
                "Content-Type":"application/json"
    ...
    function funcUpdateUser(){
        ...
        axios("http://127.0.0.1:9090/api/v1/resident-payments/update-payment-user", {
            method: 'PUT',
            headers: {
                'Authorization': tokenParam_,
                'Content-Type': 'application/json'
    ...
    function funcDeleteUser(){
        ...
        */
        ...
        if(userIDNow_){
            axios("http://127.0.0.1:9090/api/v1/resident-payments/delete-user/"+userIDNow_, {
                method: 'DELETE',
                headers: {
                    'Authorization': tokenParam_,
    ...
    function funcDeletePayment(){
        ...
        */
        ...
        if(paymentIdNow_){
            axios("http://127.0.0.1:9090/api/v1/resident-payments/delete-payment/"+paymentIdNow_, {
                method: 'DELETE',
                headers: {
                    'Authorization': tokenParam_,
                    // 'Content-Type': 'application/string'
    ...
    function funcCreateUser(){
        ...
        axios("http://127.0.0.1:9090/api/v1/resident-payments/create-user",{
            method:"POST",
            headers:{
                'Authorization':tokenParam_,
                "Content-Type":"application/json"
