...
public class OutComeController {
    ...
    public ResponseEntity<PagingResponse> getAllStaff(
        ...
        Page<OutcomeResponse> outcomeList = outcomeService.getAllOutcomeWithCondition(typeOutcomeId,
        ...
        PagingResponse<?> response = PagingResponse.builder()
                ...
                .pageSize(pageSize)
                .result(outcomeList.toList())
                .totalItem(outcomeList.getTotalElements())
                .totalPage(outcomeList.getTotalPages())
                .search(searchBody)
                .build();
